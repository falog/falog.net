---
title: "RISC-Vを目標にCPUを自作する話（実装編2-1：Rustで8bit CPUエミュレータを実装）"
...
[前回の記事](/blog/cpu/tiny/002_cpu-minimal-design)では、命令を削って最小構成の8bit CPUの設計を行った。
...
ソースコード全体は[falog_tiny_cpu (GitHub)](https://github.com/falog/falog_tiny_cpu)に置いてあるので、興味がある人はそちらも見てみてほしい。
